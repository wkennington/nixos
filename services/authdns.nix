...
in
{
  ...
  networking.firewall.extraCommands = ''
    ...
    iptables -t mangle -A OUTPUT -m owner -p tcp --dport 53 --uid-owner knot -j MARK --set-mark 0x20
    iptables -t mangle -A OUTPUT -m owner -p udp --dport 53 --uid-owner knot -j MARK --set-mark 0x20
